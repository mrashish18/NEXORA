      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-20 px-8 pt-32 lg:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-10 max-w-xl text-xl leading-9 text-slate-300">
            ...
            NEXORA transforms procurement documents,
            logistics, vendor data and project schedules
            into real-time AI insights that help construction
            companies predict delays, reduce costs and
          ...
          <div className="mt-12 flex flex-wrap gap-5">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 px-8 py-4 font-semibold shadow-lg shadow-cyan-500/30 transition duration-300 hover:scale-105"
            >
              Try Demo
              <ArrowRight size={18} />
            </button>
          ...
          <div className="relative rounded-3xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl shadow-2xl">
            ...
            <div className="mt-8 rounded-2xl bg-slate-800/60 p-6">
              ...
              <p className="mt-3 leading-8">
                Steel shipment is predicted to arrive 3 days late.
                AI recommends switching to BuildMax Steel Ltd
